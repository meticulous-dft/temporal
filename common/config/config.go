...
type (
	...
	MongoDB struct {
		// URI is a MongoDB connection string. It is mutually exclusive with Hosts.
		URI string `yaml:"uri"`
		// Hosts is a list of MongoDB replica set members
